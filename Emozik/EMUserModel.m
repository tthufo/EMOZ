...
- (NSString *)nickname {
    ...
    return _nickname.length > 0 ? /*_nickname* : _hyphenateId*/ tempInfo[@"NAME"] : tempInfo[@"NAME"];
}
...
- (NSString *)avatarURLPath {
    ...
    return _avatarURLPath.length > 0 ? /*_avatarURLPath : nil */ tempInfo[@"AVATAR"] : tempInfo[@"AVATAR"];
}
