...
- (CGSize)sizeThatFits:(CGSize)size
{
    ...
    if(self.model.message.body.type == EMMessageBodyTypeFile)
    {
        text = ((EMFileMessageBody*)self.model.message.body).displayName;//@"file lè";
    }
    else
    {
...
- (void)setModel:(EMMessageModel *)model
{
    ...
    if(model.message.body.type == EMMessageBodyTypeFile)
    {
        ...
        [_textLabel setText:((EMFileMessageBody*)model.message.body).displayName];// @"file lè"];
        
        return;
    }
    
//    if(model.message.body.type == 6)
//    {
//        _textLabel.textColor = self.model.message.direction == EMMessageDirectionSend ? WhiteColor : AlmostBlackColor;
//        
//        [_textLabel setText:@"file lè"];
//        
//        return;
//    }
