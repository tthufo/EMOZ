//
//  E_User_Karaoke_ViewController.m
//  Emozik
//
...
#import "E_User_Karaoke_ViewController.h"

@interface E_User_Karaoke_ViewController ()
{
...
@implementation E_User_Karaoke_ViewController
...
- (void)viewDidLoad
{
    ...
    [tableView withCell:@"E_User_Karaoke_Cell"];
    ...
    __block E_User_Karaoke_ViewController * weakSelf = self;
...
{
    return dataList.count == 0 ? _tableView.frame.size.height : 89;
}

- (UITableViewCell *)tableView:(UITableView *)_tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    SwipeableCell * cell = (SwipeableCell*)[_tableView dequeueReusableCellWithIdentifier:dataList.count == 0 ? @"E_Empty_Music" : @"E_User_Karaoke_Cell" forIndexPath:indexPath];
