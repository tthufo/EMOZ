...
- (void)setConversationModel:(EMConversationModel *)model andInfo:(NSArray*)info
{
    ...
    if (model.conversation.type == EMConversationTypeChat) {
        [_headImageView imageWithUsername:model.conversation.conversationId placeholderImage:[UIImage imageNamed:@"default_avatar"] andInfo:chat];
        _nameLabel.text = chat[@"NAME"];
    } else {
...
- (void)setConversationModel:(EMConversationModel *)model
{
    _model = model;
    if (model.conversation.type == EMConversationTypeChat) {
        [_headImageView imageWithAvatar:model.avatar placeholderImage:[UIImage imageNamed:@"default_avatar"]];
        _nameLabel.text = model.title;
    } else {
        _headImageView.image = [UIImage imageNamed:@"default_group_avatar"];
        _nameLabel.text = model.title;
