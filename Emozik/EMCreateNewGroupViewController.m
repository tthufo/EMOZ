...
//    }
    ...
    {
        EMUserModel *model = [[EMUserModel alloc] initWithHyphenateId:dict[@"ID"] andInfo:dict];
...
- (UITableViewCell *)tableView:(UITableView *)tableView_ cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    EMGroupPermissionCell *cell = [tableView_ dequeueReusableCellWithIdentifier:cellIdentifier];
    if (!cell) {
...
- (UIView *)tableView:(UITableView *)tableView_ viewForHeaderInSection:(NSInteger)section {
    ...
    view.backgroundColor = tableView_.backgroundColor;
    return view;
