//
//  E_Karaoke_Menu_ViewController.m
//  Emozik
//
...
@interface E_Karaoke_Menu_ViewController ()
{
...
@implementation E_Karaoke_Menu_ViewController
...
- (void)viewDidLoad
{
    ...
    __block E_Karaoke_Menu_ViewController * weakSelf = self;
...
- (IBAction)didPressMenu:(id)sender
{
    ...
    {
        [[E_Overlay_Menu shareMenu] didShowMenu:@{@"active":active,@"category":[System getValue:@"karaokeCat"],@"host":self,@"rect":[NSValue valueWithCGRect:CGRectMake(0, 114, screenWidth1, screenHeight1 - 64 - 50)]} andCompletion:^(NSDictionary *actionInfo) {
