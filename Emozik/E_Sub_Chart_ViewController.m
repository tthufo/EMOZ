...
@interface E_Sub_Chart_ViewController ()
{
...
@implementation E_Sub_Chart_ViewController
...
- (void)viewDidLoad
{
    ...
    viewHeight.constant = [optionInfo responseForKey:@"height"] ? [optionInfo[@"height"] intValue] : kHeight + 48;
    ...
    __block E_Sub_Chart_ViewController * weakSelf = self;
...
- (IBAction)didPressMenu:(id)sender
{
    ...
    {
        [[E_Overlay_Menu shareMenu] didShowMenu:@{@"active":active,@"category":[System getValue:@"chartCat"],@"host":self,@"rect":[NSValue valueWithCGRect:CGRectMake(0, viewHeight.constant, screenWidth1, screenHeight1 - viewHeight.constant - 64 - 35)]} andCompletion:^(NSDictionary *actionInfo) {
